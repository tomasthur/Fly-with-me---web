        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <a
              ...
              className="hidden lg:block bg-accent-yellow text-white px-6 py-3 rounded-full font-semibold hover:bg-accent-yellow/90 transition-colors"
            >
              Download
            </a>
          </div>
          ...
          <div className={`px-4 ${isMenuOpen ? 'pt-2 pb-3' : 'pt-0 pb-0'} space-y-1 bg-primary-dark/30 backdrop-blur-md border-t border-primary-light/10 transition-all duration-300 ease-in-out ${isMenuOpen ? 'translate-y-0' : '-translate-y-2'}`}>
            ...
            <div className="pt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-accent-yellow text-white px-6 py-3 rounded-full font-semibold hover:bg-accent-yellow/90 transition-colors"
              >
                Download
              </a>
            </div>
            ...
            <div className="text-white text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-4 sm:px-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-accent-yellow text-primary-dark px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-full font-semibold text-sm sm:text-base lg:text-lg hover:bg-accent-yellow/90 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-accent-yellow/50 animate-pulse"
                >
                  Download
                </a>
              </div>
            ...
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-accent-yellow text-primary-dark px-8 py-4 rounded-full font-semibold text-lg hover:bg-accent-yellow/90 transition-colors flex items-center justify-center space-x-3"
                >
